...
export default function RefundPolicyScreen() {
  ...
  const { data: policy } = useQuery({
    queryKey: ["policy-page", "refunds"],
    queryFn: () => fetchPolicyPage("refunds")
  });
  ...
  return (
    <Screen>
      <ScreenHeader
        ...
        subtitle={policy?.subtitle || "How Hair By Paris handles refunds, delivery issues, and support review."}
